...
public class TooltipRenderer {
    ...
    public static void drawGradientScrollingBorder(GuiGraphics graphics, int x, int y, int width, int height,
        ...
        for (int i = 0; i < segmentsPerEdge; i++) {
            ...
            consumer.addVertex(matrix, x1, y, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            consumer.addVertex(matrix, x1, y + 1, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            consumer.addVertex(matrix, x2, y + 1, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
            consumer.addVertex(matrix, x2, y, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
        }
        ...
        for (int i = 0; i < segmentsPerEdge; i++) {
            ...
            unpackColor(getDiscreteSegmentColor(pos1, offset, colors, P, segmentLen), fadeAlpha, c1);
            unpackColor(getDiscreteSegmentColor(pos2, offset, colors, P, segmentLen), fadeAlpha, c2);
            consumer.addVertex(matrix, x + width - 1, y1, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            consumer.addVertex(matrix, x + width - 1, y2, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
            consumer.addVertex(matrix, x + width, y2, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
            consumer.addVertex(matrix, x + width, y1, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
        }
        ...
        for (int i = 0; i < segmentsPerEdge; i++) {
            ...
            unpackColor(getDiscreteSegmentColor(pos1, offset, colors, P, segmentLen), fadeAlpha, c1);
            unpackColor(getDiscreteSegmentColor(pos2, offset, colors, P, segmentLen), fadeAlpha, c2);
            consumer.addVertex(matrix, x2_rev, y + height - 1, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
            consumer.addVertex(matrix, x2_rev, y + height, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
            consumer.addVertex(matrix, x1_rev, y + height, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            consumer.addVertex(matrix, x1_rev, y + height - 1, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
        }
        ...
        for (int i = 0; i < segmentsPerEdge; i++) {
            ...
            unpackColor(getDiscreteSegmentColor(pos1, offset, colors, P, segmentLen), fadeAlpha, c1);
            unpackColor(getDiscreteSegmentColor(pos2, offset, colors, P, segmentLen), fadeAlpha, c2);
            consumer.addVertex(matrix, x, y2_rev, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
            consumer.addVertex(matrix, x, y1_rev, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            consumer.addVertex(matrix, x + 1, y1_rev, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            consumer.addVertex(matrix, x + 1, y2_rev, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
        }
    ...
    public static void drawBackground(GuiGraphics graphics, int x, int y, int width, int height,
        ...
        for (int i = 0; i < segments; i++) {
            ...
            if (isVertical) {
                float y1 = bgY1 + pos1;
                float y2 = bgY1 + pos2;
                consumer.addVertex(matrix, bgX1, y1, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
                consumer.addVertex(matrix, bgX1, y2, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
                consumer.addVertex(matrix, bgX2, y2, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
                consumer.addVertex(matrix, bgX2, y1, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            } else {
                float x1 = bgX1 + pos1;
                float x2 = bgX1 + pos2;
                consumer.addVertex(matrix, x1, bgY1, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
                consumer.addVertex(matrix, x2, bgY1, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
                consumer.addVertex(matrix, x2, bgY2, 0.0f).setColor(c2[0], c2[1], c2[2], c2[3]);
                consumer.addVertex(matrix, x1, bgY2, 0.0f).setColor(c1[0], c1[1], c1[2], c1[3]);
            }
        }
    ...
    public static void drawGradientTitleBar(GuiGraphics graphics, int x, int y, int width, int height,
        ...
        for (int i = 0; i < segments; i++) {
            ...
            consumer.addVertex(matrix, x1, barY1, 0.0f).setColor(r1, g1, b1, a1);
            consumer.addVertex(matrix, x1, barY2, 0.0f).setColor(r1, g1, b1, a1);
            consumer.addVertex(matrix, x2, barY2, 0.0f).setColor(r2, g2, b2, a2);
            consumer.addVertex(matrix, x2, barY1, 0.0f).setColor(r2, g2, b2, a2);
        }
        ...
        java.util.function.BiConsumer<java.util.function.Function<Float, float[]>, Float> drawTrail = (posFunc, currentProgress) -> {
            for (int i = 0; i < tailSegments; i++) {
                ...
                if (len > 0.001f) {
                    ...
                    consumer.addVertex(matrix, pos2[0] + nx * thickness, pos2[1] + ny * thickness, 0.0f).setColor(fr, fg, fb, alpha2);
                    consumer.addVertex(matrix, pos2[0] - nx * thickness, pos2[1] - ny * thickness, 0.0f).setColor(fr, fg, fb, alpha2);
                    consumer.addVertex(matrix, pos1[0] - nx * thickness, pos1[1] - ny * thickness, 0.0f).setColor(fr, fg, fb, alpha1);
                    consumer.addVertex(matrix, pos1[0] + nx * thickness, pos1[1] + ny * thickness, 0.0f).setColor(fr, fg, fb, alpha1);
                } else if (i == 0) {
                    consumer.addVertex(matrix, pos1[0] + 1, pos1[1] - 1, 0.0f).setColor(fr, fg, fb, alpha1);
                    consumer.addVertex(matrix, pos1[0] + 1, pos1[1] + 1, 0.0f).setColor(fr, fg, fb, alpha1);
                    consumer.addVertex(matrix, pos1[0] - 1, pos1[1] + 1, 0.0f).setColor(fr, fg, fb, alpha1);
                    consumer.addVertex(matrix, pos1[0] - 1, pos1[1] - 1, 0.0f).setColor(fr, fg, fb, alpha1);
                }
